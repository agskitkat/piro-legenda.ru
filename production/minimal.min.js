...
function run_slider(){$(".slider").each(function(n,t){var e=0,r=0,o=1,i=0,a=0;function c(n){if(o+n<=r&&0<o+n){o+=n;var e=0,i=0;$(t).find(".slide").each(function(n,t){++e<o&&(i+=$(t).outerWidth())}),$(t).find(".wrap").css({"margin-left":-1*i+"px"})}}$(t).find(".slide").each(function(n,t){e+=$(t).outerWidth(),r++}),$(t).find(".wrap").css({width:e+"px"}),$(t).on("touchstart",function(n){i=n.originalEvent.touches[0].pageX}),$(t).on("touchmove",function(n){a=n.originalEvent.touches[0].pageX}),$(t).on("touchend",function(n){n.stopPropagation(),n.preventDefault();var t=i-a;t<-50&&c(-1),50<t&&c(1)}),$(t).parent().on("click",".next-arrow",function(n){c(1)}),$(t).parent().on("click",".prev-arrow",function(n){c(-1)})})}function run_video(){$(".js-play-video").click(function(){var n=$(this).attr("data-video");$("body").find(".video-modal .video-player").attr("src",n)})}function send_valid_form(n){var t=$(n).closest("form");if(check_form(t,"on-view")){$(n).html("<div class='loader_button'></div>");var e=$(t).serializeArray();$.ajax({type:"POST",url:t.attr("action"),data:e,success:function(n){$(t).closest(".callback-form").parent().html(n)}})}}function run_timer(){$(".timer").each(function(n,e){var i,r,o,a,c=(new Date).getTime()+864e5;function u(n){return(n<10?"0":"")+n}setInterval(function(){var n,t;n=(new Date).getTime(),t=(c-n)/1e3,i=u(parseInt(t/86400)),t%=86400,r=u(parseInt(t/3600)),t%=3600,o=u(parseInt(t/60)),a=u(parseInt(t%60)),$(e).find(".days").html(i),$(e).find(".hours").html(r),$(e).find(".minute").html(o),$(e).find(".seconds").html(a)},1e3)})}$().ready(function(){run_slider(),run_video(),run_timer()});
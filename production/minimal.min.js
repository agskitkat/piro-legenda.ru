...
"use strict";function menu_zz_call(){var f=!1,e=window.innerWidth,i=0,o=!1,n=37;if(1024<e&&$(".menu-block-header .menu-items > .menu-item:not('.menu-price-list')").each(function(e,t){9===++i&&($(".menu-block-header .menu-items").css({"padding-left":"20px","padding-right":"20px"}),$(t).find(".dropshadow").remove(),0===(o=$(t)).find(".menu-level-2").length?(console.log("Append"),o.append("<div class='menu-level-2'></div>")):console.log(o.find(".menu-level-2"))),9<i&&(o.addClass("tail"),$(t).find(".menu-level-2").remove(),o.find(".dropshadow").remove(),o.find(".menu-level-2").append($(t)))}),1170<e)n=20;var a=0,s=0;o&&o.hover(function(e){var t=$(this),i=0;t.addClass("open"),a=parseInt(t.css("padding-bottom")),s=parseInt(t.css("margin-bottom")),t.find(".menu-level-2 .menu-item").each(function(e,t){i+=$(t).outerHeight()}),console.log(i),t.css({"margin-bottom":-1*(i+n)+"px","padding-bottom":i+n+"px"})},function(e){var t=$(this);t.removeClass("open"),t.css({"padding-bottom":a+"px","margin-bottom":s+"px"})});var p=$(".menu-block-header .menu-items .menu-item:not(.tail)");p.on("click, mouseover",function(){var e=$(this).has(".menu-level-2").length;if(!f&&e){var t=$(this).find(".menu-level-2");f=!0,p.removeClass("open"),$(this).addClass("open");var i=window.innerWidth,o=$(this).width(),n=t.width();i<1170&&1024<=i&&t.css({left:(o-n)/2+"px"});var a=t.offset().left+n,s=+$(".menu-block-header .menu-items").width()+$(".menu-block-header .menu-items").offset().left;if(!t.attr("optimal")&&s<a){var l=$(".menu-block-header .menu-items").width(),c=a-(i-l)/2,r=$(this).css("left").replace(/[^-\d\.]/g,"")-(c-l);t.css({left:r+"px"}),t.attr({optimal:!0})}if(!t.has(".back").length){var d=$(this).find("> a .menu-item-name").html();t.prepend('<div class="back"><span class="korsar-icon arrow-back"></span><span class="name">'+d+"</span></div>")}}}),p.on("click, mouseout",function(e){e.stopPropagation(),f&&(f=!1,p.removeClass("open"))}),p.on("click",".back .arrow-back",function(e){e.stopPropagation(),$(this).closest(".open").removeClass("open"),f=!1})}function loader_zz_call(){$(".background_lizy_load").css({opacity:0,transition:"all 0.4s"}),$(".background_lizy_load").on("inview",function(e){var t=$(this);$(t).css({"background-image":"url("+$(t).attr("data-src")+")",opacity:1})}),$("img.lizy_load").css({transition:"all 0.4s",opacity:0}).closest(".img_with_sadow").find(".shadow").css({transition:"all 1s",opacity:0}),$("img.lizy_load").on("inview",function(e){var t=$(this);$(t).attr({src:$(t).attr("data-src")}),$(t).imageready(function(){$(t).css({opacity:"1"}).closest(".img_with_sadow").find(".shadow").css({opacity:1})})})}function modal_zz_call(){$(".call-modal").unbind("click").on("click",function(e){e.preventDefault();var t=$(this).attr("data-target"),i=$(this).attr("data-reachgoal");return i&&$(t).attr("data-reachgoal",i),$(t).css({display:"block"}).animate({opacity:1},200),!1}),$("body").unbind("click").on("click",".korsar-modal .close",function(e){e.preventDefault();var t=$(this).closest(".korsar-modal").find("video");return $.each(t,function(e,t){t.pause()}),$(this).closest(".korsar-modal").animate({opacity:0},200,function(){$(this).css({display:"none"})}),!1})}function start_zz_call(){$("body").on("click",".auth-link",function(e){console.log("Alert !!!")}),$(".mobile-499-800").on("touchstart mousedown",function(){window.yaCounter51429325.reachGoal("mob click 8 (499) 800-81-91")}),$(".mobile-495-737").on("touchstart mousedown",function(){window.yaCounter51429325.reachGoal("mob click 8 (495) 737-81-91")}),$(".filter-items").unbind("click").on("click",".item",function(e){if(e.preventDefault(),$(this).find("input[type=radio]").length&&($(this).closest(".filter-items").find(".current").removeClass("current"),$(this).addClass("current")),$(this).find("input[type=checkbox]").length){$(this).toggleClass("current");var t=$(this).find("input[type=checkbox]");t.prop("checked",!t.is(":checked")),console.log(smartFilter.click(t)),smartFilter.click(t)}});var o=!1;$(".filter-items .item").each(function(e,t){var i=$(this).find("input");i.is(":checked")&&(i.closest(".item").addClass("current"),i.closest(".bx-filter-parameters-box").addClass("bx-active"),o=!0)}),o||$(".bx-filter-parameters-box:first").addClass("bx-active").find(".filter-items.items-vertical").addClass("bx-active");var i=!1,n=!1,a=$(window).scrollTop();function s(){var e=i?"block":"none";$(".content_closer").css({display:e}),$("footer").css({display:e}),i=!i}function e(){var e=$(window).outerWidth(),t=e<1024,i=160;1023<e&&(i=278),$(window).scrollTop()>i?t?$(".top-fixed-header .mobile").css({display:"block",opacity:"1"}):$(".top-fixed-header .desctop").css({display:"block",opacity:"1"}):$(".top-fixed-header .mobile, .top-fixed-header .desctop").css({display:"none",opacity:"0"})}function t(e,t){var i=$(t).find(".text");1<=($(t).find("input[type=file]").files=e).length?1==e.length?i.html(e[0].name):i.html("Прикреплено файлов:"+e.length):i.html("+ Прикрепите файл при необходимости")}$(".filters-block-header .menu-btn-mobile-filters,.oreder-close-filter-block .menu-btn-mobile-filters").click(function(e){e.preventDefault();var t=$(".aside-filters");n=i?(t.addClass("korsar-hide"),!1):(t.removeClass("korsar-hide"),!0),s()}),$(".menu-block-header .menu-btn-mobile, .menu-block-header .menu-close, .top-fixed-header .menu-btn-mobile").click(function(e){e.preventDefault();var t=$(".menu-block-header .menu-items");n&&(i=!i,$(".aside-filters").addClass("korsar-hide"),n=!1),i?(t.addClass("korsar-hide"),setTimeout(function(){$(window).scrollTop(a)},100)):(a=$(window).scrollTop(),$(window).scrollTop(0),t.removeClass("korsar-hide")),s()}),$(window).scroll(function(){e()}),e(),$(".catalog-block .good_image img").each(function(e,t){var i=(t=$(t).closest(".good_image")).width(),o=.596*i;i<1024&&(o+=30),t.height(o)}),$("fieldset.select").focusin(function(){$(this).find(".options").css({display:"block"})}),$("fieldset.select .option").click(function(){var e=$(this).html();$(this).closest(".select").find("input").val(e),$(this).closest(".select").find(".options").css({display:"none"})}),$("fieldset .item").click(function(){$(this).closest("fieldset").find(".item.current").removeClass("current"),$(this).addClass("current")}),$("[data-tooltip]").each(function(e,t){var n=$(t);n.mouseover(function(){var e=$(window).width(),t=$(this).offset();$("body").append('<div class="tooltip">'+n.attr("data-tooltip")+"</div>");var i=$(".tooltip");if(e>i.width()+t.left)$(".tooltip").css({left:t.left+30+"px",top:t.top-i.height()/2+"px"});else{var o=t.left-(e-t.left)+10;$(".tooltip").css({left:o+"px",top:t.top+$(this).height()+10+"px"})}}),n.mouseout(function(e){$(".tooltip").remove()})}),$(".attach-file").on("dragover",function(e){e.preventDefault(),e.stopPropagation()}),$(".attach-file").on("dragenter",function(e){$(this).addClass("dragenter"),e.preventDefault(),e.stopPropagation()}),$(".attach-file").on("dragleave",function(e){$(this).removeClass("dragenter"),e.preventDefault(),e.stopPropagation()}),$(".attach-file").on("drop",function(e){$(this).removeClass("dragenter"),e.originalEvent.dataTransfer&&e.originalEvent.dataTransfer.files.length&&(e.preventDefault(),e.stopPropagation(),t(e.originalEvent.dataTransfer.files,$(this)))}),$(".attach-file").on("click",function(e){e.preventDefault(),e.stopPropagation(),$(this).find("input[type=file]").trigger("click")}),$(".attach-file input[type=file]").on("click",function(e){e.stopPropagation()}),$(".attach-file input[type=file]").on("change",function(e){console.log($(this).files),e.preventDefault(),e.stopPropagation(),t(e.target.files,$(this).parent())}),$(".menu-back-link").click(function(){return parent.history.back(),!1}),$().ready(function(){var t="first";$(".oreder-close-filter-block a").on("touchstart click",function(e){e.preventDefault(),"second"===t&&(window.location.href=$(this).attr("data-href")),"first"===t&&(t="second",$(this).closest(".order").addClass("tap-first"))})}),$("#js-target-main-review-slider").slick({infinite:!1,speed:300,slidesToShow:2,slidesToScroll:2,adaptiveHeight:!0,dots:!1,lazyLoad:"ondemand",responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".js-target-slider-goods").slick({infinite:!1,speed:300,slidesToShow:4,slidesToScroll:4,adaptiveHeight:!0,dots:!1,lazyLoad:"ondemand",responsive:[{breakpoint:1440,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]})}$().ready(function(){start_zz_call(),menu_zz_call(),modal_zz_call(),loader_zz_call()}),window.dataLayer=window.dataLayer||[];
